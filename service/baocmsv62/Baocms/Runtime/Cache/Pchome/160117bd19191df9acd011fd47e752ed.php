                ...
                <ul>
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$item): ?><li class="sjsy_sjLi">
                            ...
                            <div class="left sjsy_sjLi_l">
                                ...
                                <a class="sjsy_ljzx" rel="<?php echo U('shop/yuyue',array('shop_id'=>$item['shop_id']));?>" data="<?php echo ($item["shop_name"]); ?>"  href="javascript:void(0);">立即咨询</a>
                            ...
                            <div class="left sjsy_sjLi_c">
                                ...
                                <p class="sjsy_sjP"><?php if($item["tel"] != null): ?><p>电话:<?php echo ($item["tel"]); if($item['extension'] != null): ?><span> 转 </span><?php echo ($item["extension"]); ?><span>分机</span><?php endif; else: ?><p>手机:<?php echo ($item["mobile"]); ?></p><?php endif; ?><span class="sjsy_sjLiBq">标签：<?php if($tagsarray == null): ?><a href="javascript:void(0);">暂无标签</a> 
                            ...
                            <div class="right sjsy_sjLi_r">
                                ...
                                <?php if($details[$item['shop_id']]['wei_pic'] == null): ?><img src="__PUBLIC__/img/wx.png"  width="129" height="129"/><?php else: ?><img src="<?php echo ($details[$item['shop_id']]['wei_pic']); ?>" width="129" height="129" /><?php endif; ?>

                                <p><a class="sjsy_ljzx2" style="margin-top: 5px; width: 113px; " mini='act' href="<?php echo U('shop/favorites',array('shop_id'=>$item['shop_id']));?>">立即关注</a></p>
            ...
            <tr>
                ...
                <td>
                    ...
                    <select id="yuyue_time" name="data[yuyue_time]" class="dhInput" >
                        ...
                        <?php $__FOR_START_22563__=0;$__FOR_END_22563__=24;for($i=$__FOR_START_22563__;$i < $__FOR_END_22563__;$i+=1){ ?><option value="<?php echo ($i); ?>:00"><?php echo ($i); ?>:00</option>
            ...
            <tr>
                ...
                <td>
                    ...
                    <select id="number" name="data[number]" class="dhInput">
                        ...
                        <?php $__FOR_START_26091__=1;$__FOR_END_26091__=10;for($i=$__FOR_START_26091__;$i < $__FOR_END_26091__;$i+=1){ ?><option <?php if(($number) == $i): ?>selected="selected"<?php endif; ?> value="<?php echo ($i); ?>"><?php echo ($i); ?>人</option><?php } ?>
