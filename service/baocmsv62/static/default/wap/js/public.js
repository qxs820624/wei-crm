...
function check_user_mobile(url1,url2){
	layer.open({
		...
		area: ['90%', '340px'], //宽高
		content: '<div class="form-auto form-x"><div class="form-group"><div class="label"><label>手机号</label></div><div class="field form-inline"><input class="input input-auto" name="mobile" id="mobile" value="" placeholder="填写手机号码" size="15" type="text"> <button class="button" id="jq_send">获取验证码</button></div></div><div class="form-group"><div class="label"><label>验证码</label></div><div class="field"><input class="input input-auto" name="yzm" id="yzm" value="" size="10" placeholder="填写验证码" type="text"></div></div><div class="form-button"><button id="go_mobile" class="button" type="submit">立刻认证</button></div></div>'
	});
	//获取验证码
	var mobile_timeout;
