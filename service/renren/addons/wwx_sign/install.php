...
*/
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('wwx_sign') . " (
...
*/
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('wwx_sign_user') . " (
`id` int(10) unsigned  AUTO_INCREMENT,
`sid` int(10) NOT  NULL ,
...
*/
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('wwx_sign_record') . " (
`id` int(10) unsigned  AUTO_INCREMENT,
`uid` int (10) NOT NULL,
`openid` varchar(200)NOT NULL,
...
*/
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('wwx_sign_serial') . " (
...
*/
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('wwx_sign_award') . " (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
*/
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('wwx_sign_token') . " (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
