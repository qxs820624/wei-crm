...
if ($_W['isajax']) {
    if ($operation == 'display') {
        ...
        if (empty($id)) {
            ...
            $sql              = 'SELECT id as goodsid,type,title,weight,issendfree,isnodiscount, thumb,marketprice,storeids,isverify,deduct,virtual,maxbuy,usermaxbuy,discounts,total as stock FROM ' . tablename('ewei_shop_goods') . ' where id=:id and uniacid=:uniacid  limit 1';
