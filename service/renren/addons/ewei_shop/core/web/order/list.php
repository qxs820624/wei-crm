...
if ($operation == 'display') {
            ...
            if ($value['agentid'] == $agentid) {
                ...
                if ($agent['level3'] > 0) {
                    ...
                    foreach ($level3_commissions as $c) {
                        ...
                        $commissions = unserializer($c['commissions']);
                        if (empty($commissions)) {
                            $commission_level += isset($commission['level' . $agentLevel['id']]) ? $commission['level' . $agentLevel['id']] : $commission['default'];
                        } else {
    ...
    $total              = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join ( select rr.id,rr.orderid,rr.status from " . tablename('ewei_shop_order_refund') . " rr left join " . tablename('ewei_shop_order') . " ro on rr.orderid =ro.id order by rr.id desc limit 1) r on r.orderid= o.id" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition $statuscondition", $paras);
    $totalmoney         = pdo_fetchcolumn('SELECT ifnull(sum(o.price),0) FROM ' . tablename('ewei_shop_order') . " o " . " left join ( select rr.id,rr.orderid,rr.status from " . tablename('ewei_shop_order_refund') . " rr left join " . tablename('ewei_shop_order') . " ro on rr.orderid =ro.id order by rr.id desc limit 1) r on r.orderid= o.id" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition $statuscondition", $paras);
    $totals             = array();
    $totals['all']      = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join ( select rr.id,rr.orderid,rr.status from " . tablename('ewei_shop_order_refund') . " rr left join " . tablename('ewei_shop_order') . " ro on rr.orderid =ro.id order by rr.id desc limit 1) r on r.orderid= o.id" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE o.uniacid = :uniacid and o.deleted=0", $paras);
    $totals['status_1'] = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join ( select rr.id,rr.orderid,rr.status from " . tablename('ewei_shop_order_refund') . " rr left join " . tablename('ewei_shop_order') . " ro on rr.orderid =ro.id order by rr.id desc limit 1) r on r.orderid= o.id" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=-1 and o.refundtime=0", $paras);
    ...
    $totals             = array();
    $totals['all']      = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join ( select rr.id,rr.orderid,rr.status from " . tablename('ewei_shop_order_refund') . " rr left join " . tablename('ewei_shop_order') . " ro on rr.orderid =ro.id order by rr.id desc limit 1) r on r.orderid= o.id" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition", $paras);
    $totals['status_1'] = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join ( select rr.id,rr.orderid,rr.status from " . tablename('ewei_shop_order_refund') . " rr left join " . tablename('ewei_shop_order') . " ro on rr.orderid =ro.id order by rr.id desc limit 1) r on r.orderid= o.id" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=-1 and o.refundtime=0", $paras);
    $totals['status0']  = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join ( select rr.id,rr.orderid,rr.status from " . tablename('ewei_shop_order_refund') . " rr left join " . tablename('ewei_shop_order') . " ro on rr.orderid =ro.id order by rr.id desc limit 1) r on r.orderid= o.id" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=0", $paras);
    $totals['status1']  = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join ( select rr.id,rr.orderid,rr.status from " . tablename('ewei_shop_order_refund') . " rr left join " . tablename('ewei_shop_order') . " ro on rr.orderid =ro.id order by rr.id desc limit 1) r on r.orderid= o.id" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=1", $paras);
    $totals['status2']  = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join ( select rr.id,rr.orderid,rr.status from " . tablename('ewei_shop_order_refund') . " rr left join " . tablename('ewei_shop_order') . " ro on rr.orderid =ro.id order by rr.id desc limit 1) r on r.orderid= o.id" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=2", $paras);
