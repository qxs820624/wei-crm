...
<div class="wwi-container wrapper" >
  ...
  <div class="wwi-module">
  <div class="title">
<h3><b>'<?php echo $output['show_keyword'];?>'</b>热销商品</h3></div>
...
<div id="gc_goods_recommend_div" ></div>
    ...
    <div class="wwi-module"><?php echo loadadv(37,'html');?></div>
        ...
        <!-- S 推荐展位 -->
    <div nctype="booth_goods" class="wwi-module" style="display:none;"> </div>
  </div>
  <div class="left"> 
    <!-- 分类下的推荐商品 -->
    <div class="shop_con_list" id="main-nav-holder">
      <nav class="sort-bar" id="main-nav">
        ...
        <div class="wwi-all-category">
          <div class="all-category">
            <?php require template('layout/home_goods_class');?>
          </div>
        </div>
        <div class="wwi-sortbar-array">
          <ul>
        ...
        <div class="wwi-sortbar-filter" nc_type="more-filter">
        ...
        <div class="wwi-sortbar-location">商品所在地：
  ...
  <div class="clear"></div>
    ...
    <div id="guesslike_div" style="width:980px;"></div></div><div class="right"><?php if(!empty($output['viewed_goods']) && is_array($output['viewed_goods'])){?><div class="wwi-module wwi-module-style03">
      <div class="title">
        <h3><?php echo $lang['goods_class_viewed_goods']; ?></h3>
      </div>
      <div class="content">
        <div class="wwi-sidebar-viewed" id="wwiSidebarViewed">
          <ul>
            
            <?php foreach ($output['viewed_goods'] as $k=>$v){?>
            <li class="wwi-sidebar-bowers">
        ...
        <a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_goodsbrowse&op=list" class="wwi-sidebar-all-viewed">全部浏览历史</a></div>
    </div><?php } ?></div></div>
</div>
...
$(function(){
  ...
  $('[nc_type="area_name"]').html('<?php echo $output['province_array'][intval($_GET['area_id'])]; ?>');
	...
	<?php }?>
	//浏览历史处滚条
	$('#wwiSidebarViewed').perfectScrollbar({suppressScrollX:true});
