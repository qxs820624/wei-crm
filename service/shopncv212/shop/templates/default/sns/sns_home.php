...
<div class="left-content">
  ...
  <div class="tabmenu">
    <ul class="tab">
      <li class="active"><a mef="sqde" href="index.php?act=member_snshome&op=shareglist<?php if(!empty($output['master_id'])){ echo '&mid='.$output['master_id']; }?>"><?php if ($output['relation'] == 3){echo $lang['sns_me']; }else {?>TA<?php }echo $lang['sns_share_of_goods'];?></a></li>
