 ...
 * of MicroService, minus variables that may be security-sensitive (like
 * passwords).
 * URL: http://identi.ca/api/microservice/config.(xml|json)
 * Formats: xml, json
 *
 * @category API
 * @package  MicroService
 ...
 * @link     http://www.microservice.com
 */
class ApiMicroserviceConfigAction extends ApiAction
{
    var $keys = array(
