...
class SessionsadminpanelAction extends AdminPanelAction
{
    ...
    function getInstructions()
    {
        ...
        return _('Session settings for this MicroService site');
    }
...
class SessionsAdminPanelForm extends AdminForm
{
    ...
    function formData()
    {
        ...
        // TRANS: Indicates if MicroService should handle session administration.
        ...
        // TRANS: Indicates if MicroService should write session debugging output.
