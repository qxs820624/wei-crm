...
require_once INSTALLDIR . '/lib/microserviceoauthstore.php';
...
class OauthconnectionssettingsAction extends SettingsAction
{
    ...
    function revokeAccess($token)
    {
        ...
        $datastore = new ApiMicroServiceOAuthDataStore();
    ...
    function showSections()
    {
        ...
        $devMsg = sprintf(
            ...
            _('Are you a developer? [Register an OAuth client application](%s) to use with this instance of MicroService.'),
