...
class Notice extends Managed_DataObject
{
    ...
    /**
     * Pull @-replies from this message's content in MicroService markup format
     ...
     * @param User $cur Current user
     *
     * @return array representation of <microservice:notice_info> element
     */
    ...
    function noticeInfo($cur)
    {
        ...
        return array('microservice:notice_info', $noticeInfoAttr, null);
    }
