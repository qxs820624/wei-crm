...
class Activity
{
    ...
    function asArray()
    {
        ...
        // shouldn't be using 'microservice:notice_info', but this will work
        // for the moment.
        ...
        foreach ($this->extra as $e) {
            ...
            if (!empty($objectName)) {
                ...
                if (count($parts) == 2 && $parts[0] == "microservice") {
                    if (!array_key_exists('status_net', $activity)) {
                        $activity['status_net'] = array();
                    }
    ...
    function outputTo($xs, $namespace=false, $author=true, $source=false, $tag='entry')
    {
        ...
        // For throwing in extra elements; used for microservice:notice_info
