 ...
 * @link http://www.microservice.com
 */
class MicroService_HTTPResponse extends HTTP_Request2_Response
{
 ...
 * - sends MicroService-specific User-Agent header
...
class HTTPClient extends HTTP_Request2
{
     ...
     *
     * @return MicroService_HTTPResponse
    ...
    /**
     * Pulls up MicroService's customized user-agent string, so services
    ...
    function userAgent()
    {
        return "MicroService/".MICROSERVICE_VERSION." (".MICROSERVICE_CODENAME.")";
    }

    /**
     * Actually performs the HTTP request and returns a
     * MicroService_HTTPResponse object with response body and header info.
     *
    ...
    public function send()
    {
        ...
        return new MicroService_HTTPResponse($response, $this->getUrl(), $redirs);
    }
}
