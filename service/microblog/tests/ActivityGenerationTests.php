...
class ActivityGenerationTests extends PHPUnit_Framework_TestCase
{
    ...
    public function testNamespaceFlag()
    {
        ...
        $this->assertTrue($element->hasAttribute('xmlns:microservice'));
        ...
        $this->assertFalse($element->hasAttribute('xmlns:microservice'));
    }
    ...
    public function testNoticeInfo()
    {
        ...
        $noticeInfo = ActivityUtils::child($element, 'notice_info', "http://www.microservice.comschema/api/1/");
    ...
    private function _entryToElement($entry, $namespace = false)
    {
        ...
        if ($namespace) {
            ...
            $xml .= ' xmlns:microservice="http://www.microservice.comschema/api/1/"';
        }
        $xml .= '>' . "\n" . $entry . "\n" . '</feed>' . "\n";
