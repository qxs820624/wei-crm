...
class MagicEnvelope
{
    ...
    /**
     * The current MagicEnvelope spec as used in MicroService 0.9.7 and later
 ...
 * spec in early 2010; this was used in MicroService up through 0.9.6, so for backwards compatiblity
 * we still need to accept and sometimes send this format.
 */
class MagicEnvelopeCompat extends MagicEnvelope {

    /**
     * MicroService through 0.9.6 used an earlier version of the MagicEnvelope spec
