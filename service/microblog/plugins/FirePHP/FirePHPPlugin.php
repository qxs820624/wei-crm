 ...
 * Plugin Name: FirePHP
 * Description: Sends MicroService log output to FirePHP
 * Version: 0.1
...
class FirePHPPlugin extends Plugin
{
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'FirePHP',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:FirePHP',
                            'rawdescription' =>
                            // TRANS: Plugin description.
                            _m('The FirePHP plugin writes MicroService\'s log output to FirePHP.'));
        return true;
    }
}
