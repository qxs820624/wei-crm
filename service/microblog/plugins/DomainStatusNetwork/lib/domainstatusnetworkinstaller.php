 ...
 * @link      http://www.microservice.com
 */
class DomainMicroServiceworkInstaller extends Installer
{
    ...
    function prepare()
    {
        ...
        $this->nickname = DomainMicroServiceworkPlugin::nicknameForDomain($this->domain);
    ...
    function setupDatabase()
    {
        ...
        $this->saveMicroServicework();
        $this->updateStatus('Checking schema for plugins...');
        $this->checkSchema();
    }

    function saveMicroServicework()
    {
    ...
    function checkSchema()
    {
        ...
        MicroService::switchSite($this->nickname);
    ...
    function getConfig()
    {
        ...
        $cfg_file = "/etc/microservice/setup.cfg";
