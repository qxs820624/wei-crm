...
class DirectionDetectorPlugin extends Plugin {
    ...
    private static function getClearText($str){
        ...
        $str = preg_replace('/^RT[: ]{1}| RT | RT: |^RD[: ]{1}| RD | RD: |[鈾衡櫥:]/u', '', $str); // redent, retweet
    ...
    function onPluginVersion(&$versions){
        $url = 'http://www.microservice.comwiki/Plugin:DirectionDetector';
...
/*
// Example:
var_dump(DirectionDetectorPlugin::isRTL('RT @everplays 鈾�: 丿丕丿诏丕賴 亘賴 丿賱賷賱 毓丿賲 丨囟賵乇 賵讴賱丕蹖 賲鬲賴賲丕賳 亘賳丕 亘乇 丕氐賱 佟伲佶 賯丕賳賵賳 丕爻丕爻蹖 睾賷乇 賯丕賳賵賳蹖 丕爻鬲')); // true
*/
