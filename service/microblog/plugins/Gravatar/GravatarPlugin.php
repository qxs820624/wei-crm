...
class GravatarPlugin extends Plugin
{
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'Gravatar',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:Gravatar',
                            'rawdescription' =>
                            // TRANS: Plugin decsription.
                            _m('The Gravatar plugin allows users to use their <a href="http://www.gravatar.com/">Gravatar</a> with MicroService.'));
