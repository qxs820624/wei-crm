 ...
 *
 * A sample module to show best practices for MicroService plugins
 *
 * PHP version 5
 *
 ...
 *
 * Each plugin requires a main class to interact with the MicroService system.
 *
 * The main class usually extends the Plugin class that comes with MicroService.
 *
 ...
 * main MicroService distribution go in 'plugins' and third-party or local ones go
 * in 'local'.
 *
...
class SamplePlugin extends Plugin
{
     ...
     *
     * Plugins can add their own tables to the MicroService database. Plugins
     * should use MicroService's schema interface to add or delete tables. The
     * ensureTable() method provides an easy way to ensure a table's structure
     * and availability.
     *
     * By default, the schema is checked every time MicroService is run (say, when
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'Sample',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:Sample',
                            'rawdescription' =>
