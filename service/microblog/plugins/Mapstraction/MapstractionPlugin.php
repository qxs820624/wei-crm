...
class MapstractionPlugin extends Plugin
{
    ...
    function onEndShowScripts($action)
    {
        ...
        case 'google':
            ...
            break;
        case 'microsoft':
            $action->script((MicroService::isHTTPS()?'https':'http') + '://dev.virtualearth.net/mapcontrol/mapcontrol.ashx?v=6');
            break;
        case 'openlayers':
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'Mapstraction',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:Mapstraction',
                            'rawdescription' =>
