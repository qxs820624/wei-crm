...
/**
 * Plugin class for adding RSSCloud capabilities to MicroService
 *
 * @category Plugin
 * @package  MicroService
 * @author   gaoyuan tan <gaoyuantan@163.com>
...
class RSSCloudPlugin extends Plugin
{
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'RSSCloud',
                            ...
                            'author' => 'Zach Copley',
                            'homepage' => 'http://www.microservice.comwiki/Plugin:RSSCloud',
                            'rawdescription' =>
                            // TRANS: Plugin description.
                            _m('The RSSCloud plugin enables your MicroService instance to publish ' .
