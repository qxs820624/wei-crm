...
//		$orders = pdo_fetchall("select orderno,status,id,ptime,mobile from" . tablename('tg_order') . "where checkpay = 0 $content");
...
//			}else{
//				if($value['mobile']=='虚拟'){
//					pdo_update('tg_order', array('status'=>1,'pay_type'=>0,'ptime'=>''), array('id' => $value['id']));
//				}else{
//					pdo_update('tg_order', array('status'=>0,'pay_type'=>0,'ptime'=>''), array('id' => $value['id']));
//				}
//				
//			}
//		}
...
//	}
	...
	// 	global $_GPC, $_W;
	// 	include_once IA_ROOT . '/addons/feng_fightgroups/source/WxPay.Api.php';
	// 	load() -> model('account');
