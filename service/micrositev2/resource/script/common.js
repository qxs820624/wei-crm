...
function UEditor(selector) {
	...
	var option = {
		toolbars:[
			['fullscreen', 'source', '|', 'removeformat', 'bold', 'italic', 'underline', '|', 'forecolor', 'backcolor', 'fontsize', 'insertorderedlist', 'insertunorderedlist', '|', 'link', 'insertimage', 'insertvideo', 'music', 'map', 'tel']
		],
		savePath : ['images'],
