                ...
                <div class="nr">
                    ...
                    <div class="cen">
                        <ul>
                            ...
                            <li>PHP+MYSQL</li>
                            <li>baocms团队</li>
                            <li><a href="http://www.goodziyuan.com">好资源源码(goodziyuan.com)</a></li>
                            <li><a href="http://www.goodziyuan.com">好资源源码(goodziyuan.com)</a></li>
                            <li>本源码由 <a href="www.goodziyuan.com">好资源源码(goodziyuan.com)</a> 测试提供！</li>
                        </ul>
                    </div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="nr">
                    ...
                    <div class="cen">
                        <ul>
                            ...
                            <li>好资源源码(goodziyuan.com)建议：最好别使用虚拟空间，都是做运营的不图那个便宜！有独立服务器的使用独立服务器，没有的建议使用阿里云或者腾讯云！</li>
                            <li></li>
                        </ul>
                    </div>
                    <div class="clear"></div>
