<?php
	...
	/*判断地区邮费*/
			...
			$carrier_list = array();
			$dispatch = false;
			$dispatch_list = pdo_fetchall("select id,dispatchname,dispatchtype,firstprice,firstweight,secondprice,secondweight,areas,carriers from " . tablename("tg_dispatch") . " WHERE enabled=1 and uniacid = {$_W['uniacid']}  order by displayorder desc");
