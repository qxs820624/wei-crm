<?php defined('IN_IA') or exit('Access Denied');?>			</div>
		...
		<div class="center-block footer" role="footer">
			...
			<div class="text-center">
				<?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.012wz.com"><b>微赞</b></a> v<?php echo IMS_VERSION;?> &copy; 2014 <a href="http://www.goodziyuan.com">www.goodziyuan.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
			</div>
		</div>
	</div>
