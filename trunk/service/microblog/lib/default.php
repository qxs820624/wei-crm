 ...
 * @copyright 2008-9 MicroService, Inc.
...
$default =
    array('site' =>
        array('name' => 'Just another MicroService microblog',
              'nickname' => 'microservice',
              'wildcard' => null,
              'server' => $_server,
              'theme' => 'neo',
              'path' => $_path,
              'logfile' => '/var/log/microservice.log',
              'logo' => null,
              'ssllogo' => null,
              'logdebug' => false,
        ...
        'syslog' =>
        array('appname' => 'microservice', # for syslog
        ...
        array('enabled' => false,
              ...
              'stomp_server' => null,
              'queue_basename' => '/queue/microservice/',
              'control_channel' => '/topic/microservice/control', // broadcasts to all queue daemons
              'stomp_username' => null,
              'stomp_password' => null,
        ...
        array('enabled' => false),
        'integration' =>
        array('source' => 'MicroService', # source attribute for Twitter
        ...
        array('run' => 'web',
              'frequency' => 10000,
              'reporturl' => 'http://www.microservice.comstats/report'),
        'attachments' =>
        array('server' => null,
              'dir' => INSTALLDIR . '/file/',
              'path' => $_path . '/file/',
