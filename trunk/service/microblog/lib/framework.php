 ...
 * Copyright (C) 2008-2010, MicroService, Inc.
 *
...
define('MICROSERVICE_BASE_VERSION', '1.1.1');
define('MICROSERVICE_LIFECYCLE', 'release'); // 'dev', 'alpha[0-9]+', 'beta[0-9]+', 'rc[0-9]+', 'release'
define('MICROSERVICE_VERSION', MICROSERVICE_BASE_VERSION . '-' . MICROSERVICE_LIFECYCLE);

define('LACONICA_VERSION', MICROSERVICE_VERSION); // compatibility

define('MICROSERVICE_CODENAME', 'OK');
...
{
    return MicroService::addPlugin($name, $attrs);
}

function _have_config()
{
    return MicroService::haveConfig();
}
...
function PEAR_ErrorToPEAR_Exception($err)
{
    ...
    //That behavior is weird, and not how the rest of MicroService works.
