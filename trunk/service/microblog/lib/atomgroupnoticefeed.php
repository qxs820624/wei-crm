...
class AtomGroupNoticeFeed extends AtomNoticeFeed
{
    ...
    function __construct($group, $cur = null, $indent = true) {
        ...
        // Versions of MicroService under 0.9.7 treat <author> as a person
        ...
        $depMsg = 'Deprecation warning: activity:subject is present '
            ...
            . 'removed in the next version of MicroService.';
    ...
    function initFeed()
    {
        ...
        $this->element('microservice:group_info', $attrs, null);
    }
}
