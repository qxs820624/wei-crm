...
VALUES
    ...
    ('MicroService Desktop', 'MicroService Desktop', 'http://www.microservice.comdesktop', now()),
    ('MicroService Mobile', 'MicroService Mobile', 'http://www.microservice.commobile', now()),
    ('MicroService iPhone', 'iPhone', 'http://www.microservice.comiphone', now()),
    ('MicroService Android', 'Android', 'http://www.microservice.comandroid', now()),
    ('MicroService Blackberry', 'Blackberry', 'http://www.microservice.comblackberry', now()),
