...
class InfiniteScrollPlugin extends Plugin
{
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'InfiniteScroll',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:InfiniteScroll',
                            'rawdescription' =>
                            // TRANS: Plugin dscription.
                            _m('Infinite Scroll adds the following functionality to your MicroService installation: When a user scrolls towards the bottom of the page, the next page of notices is automatically retrieved and appended. This means they never need to click "Next Page", which dramatically increases stickiness.'));
        return true;
    }
}
