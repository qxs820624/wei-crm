...
class CasAuthenticationPlugin extends AuthenticationPlugin
{
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'CAS Authentication',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:CasAuthentication',
                            // TRANS: Plugin description. CAS is Central Authentication Service.
                            'rawdescription' => _m('The CAS Authentication plugin allows for MicroService to handle authentication through CAS (Central Authentication Service).'));
        return true;
    }
}
