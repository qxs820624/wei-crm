 ...
 * Copyright (C) 2010-2011, MicroService, Inc.
 *
 * A plugin for integrating Facebook with MicroService. Includes single-sign-on
 ...
 * @package   MicroService
 * @author   gaoyuan tan <gaoyuantan@163.com>
 * @copyright 2010-2011 MicroService, Inc.
 * @license   http://www.fsf.org/licensing/licenses/agpl-3.0.html AGPL 3.0
 * @link      http://www.microservice.com
 */
class FacebookBridgePlugin extends Plugin
{
     ...
     *
     * We maintain a table mapping MicroService notices to Facebook items
     *
     * @see Schema
     * @see ColumnDef
     *
...
ENDOFSCRIPT;
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array(
            ...
            'homepage' => 'http://www.microservice.comwiki/Plugin:FacebookBridge',
            'rawdescription' =>
             // TRANS: Plugin description.
            _m('A plugin for integrating MicroService with Facebook.')
        );
