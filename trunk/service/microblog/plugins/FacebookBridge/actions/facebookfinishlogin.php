...
class FacebookfinishloginAction extends Action
{
    ...
    function checkForExistingLink() {
        ...
        if (!empty($flink)) {
            ...
            $this->clientError(
                ...
                // TRANS: in the same MicroService site.
    ...
    function showContent()
    {
        ...
        $this->elementEnd('li');
        $this->elementEnd('ul');
        // TRANS: Submit button to connect a Facebook account to an existing MicroService account.
     ...
     * MicroService avatar for the new user.
     */
