...
class FacebooksettingsAction extends SettingsAction {
    ...
    function showContent() {
        if (!empty($this->flink)) {
            ...
            if (empty($this->user->password)) {
                ...
                $msg = sprintf(
                    // TRANS: Notice in disconnect from Facebook form if user has no local MicroService password.
                ...
                // TRANS: Message displayed when initiating disconnect of a MicroService user
                // TRANS: from a Facebook account. %1$s is the MicroService site name.
    ...
    function disconnect() {
        ...
        // TRANS: Confirmation message. MicroService account was unlinked from Facebook.
