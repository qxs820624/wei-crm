...
class Facebookclient
{
    ...
    protected $flink         = null; // Foreign_link MicroService -> Facebook
    ...
    function mailFacebookDisconnect()
    {
        ...
        // TRANS: E-mail body. %1$s is a username, %2$s is the MicroService sitename.
        $msg = _m("Hi %1\$s,\n\n".
    ...
    static function emailWarn($user)
    {
        ...
        // TRANS: E-mail subject. %s is the MicroService sitename.
        $subject = _m('Contact the %s administrator to retrieve your account');

        // TRANS: E-mail body. %1$s is a username,
        // TRANS: %2$s is the MicroService sitename, %3$s is the site contact e-mail address.
        $msg = _m("Hi %1\$s,\n\n".
