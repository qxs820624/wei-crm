...
class LdapAuthenticationPlugin extends AuthenticationPlugin
{
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'LDAP Authentication',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:LdapAuthentication',
                            'rawdescription' =>
                            // TRANS: Plugin description.
                            _m('The LDAP Authentication plugin allows for MicroService to handle authentication through LDAP.'));
        return true;
    }
}
