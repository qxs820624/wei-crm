...
class OStatusPlugin extends Plugin
{
     ...
     *   join group+microservice@identi.ca
     *   join http://identi.ca/group/microservice
     *   drop identi.ca/group/microservice
     *
     * @param Command $command
     * @param string $arg
    ...
    function onEndShowMicroServiceStyles($action) {
        $action->cssLink($this->path('theme/base/css/ostatus.css'));
        return true;
    }

    function onEndShowMicroServiceScripts($action) {
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'OStatus',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:OStatus',
