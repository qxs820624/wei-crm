...
class Ostatus_profile extends Managed_DataObject
{
    ...
    /**
     * Fetch the MicroService-side profile for this feed
     * @return Profile
     */
    ...
    /**
     * Fetch the MicroService-side peopletag for this feed
     * @return Profile
     */
    ...
    public function processShare($activity, $method)
    {
        ...
        if (Notice::contentTooLong($shortened)) {
            ...
            if (Notice::contentTooLong($shortSummary)) {
                ...
                // TRANS: this will usually be replaced with localised text from MicroService core messages.
    ...
    protected function updateAvatar($url)
    {
        ...
        // problems later on:
        //
        // http://www.microservice.comopen-source/issues/2663
    ...
    function checkAuthorship($activity)
    {
        if ($this->isGroup() || $this->isPeopletag()) {
            ...
            if ($oprofile->isGroup() || $oprofile->isPeopletag()) {
                // Groups can't post notices in MicroService.
