...
class SphinxSearchPlugin extends Plugin
{
    ...
    function onAutoload($cls)
    {
        switch ($cls) {
        case 'SphinxSearch':
            include_once INSTALLDIR . '/plugins/SphinxSearch/' .  strtolower($cls) . '.php';
            include_once INSTALLDIR . '/plugins/SphinxSearch/sphinxapi.php';
            return false;
        default:
            return true;
        }
    ...
    {
        $url = 'http://www.microservice.comwiki/Plugin:SphinxSearch';
