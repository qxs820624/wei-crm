...
/**
 * Plugin to add Google Adsense to MicroService sites
 *
 * This plugin lets you add Adsense ad units to your MicroService site.
 *
...
class AdsensePlugin extends UAPPlugin
{
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'BlankAdPlugin',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:Adsense',
                            'rawdescription' =>
                            // TRANS: Plugin description.
                            _m('Plugin to add Google AdSense to MicroService sites.'));
        return true;
    }
}
