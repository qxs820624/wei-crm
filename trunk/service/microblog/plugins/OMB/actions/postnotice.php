...
class PostnoticeAction extends Action
{
    ...
    function checkNotice()
    {
        ...
        if ($license && !common_compatible_license($license, $site_license)) {
            // TRANS: Exception thrown if a notice's license is not compatible with the MicroService site license.
            // TRANS: %1$s is the notice license, %2$s is the MicroService site's license.
