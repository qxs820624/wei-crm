 ...
 * Class for doing OAuth authentication against Twitter
 *
 * Peforms the OAuth "dance" between MicroService and Twitter -- requests a token,
 * authorizes it, and exchanges it for an access token.  It also creates a link
 * (Foreign_link) between the MicroService user and Twitter user and stores the
...
class TwitterauthorizationAction extends Action
{
    ...
    function handle($args)
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            // User was not logged in to MicroService before
     ...
     *
     * @param int        $user_id MicroService user ID
    ...
    function showPageNotice()
    {
        if ($this->error) {
            ...
            $this->element('div', 'instructions',
                           // TRANS: Page instruction. %s is the MicroService sitename.
	...
	if (common_config('site', 'inviteonly') == false) {
            ...
            $this->elementEnd('ul');
            // TRANS: Button text for creating a new MicroService account in the Twitter connect page.
        ...
        // TRANS: %s is the license as configured for the MicroService site.
        ...
        $this->elementEnd('ul');
        $this->elementEnd('fieldset');
        // TRANS: Button text for connecting an existing MicroService account in the Twitter connect page..
