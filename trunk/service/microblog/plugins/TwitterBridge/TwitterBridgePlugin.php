...
{
    const VERSION = MICROSERVICE_VERSION;
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array(
            ...
            'homepage' => 'http://www.microservice.comwiki/Plugin:TwitterBridge',
            // TRANS: Plugin description.
            'rawdescription' => _m('The Twitter "bridge" plugin allows integration ' .
                'of a MicroService instance with ' .
     ...
     *
     * We maintain a table mapping MicroService notices to Twitter statuses
     *
     * @see Schema
     * @see ColumnDef
     *
