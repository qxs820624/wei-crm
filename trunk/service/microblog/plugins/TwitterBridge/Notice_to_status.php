 ...
 *
 * Notices flow back and forth between Twitter and MicroService. We use this
 * table to remember which MicroService notice corresponds to which Twitter
 * status.
 *
...
class Notice_to_status extends Memcached_DataObject
{
     ...
     * won't appear in MicroService's own keys list. In most cases, this will
     ...
     *
     * @param integer $notice_id ID of the notice in MicroService
