...
class LdapAuthorizationPlugin extends AuthorizationPlugin
{
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'LDAP Authorization',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:LdapAuthorization',
                            'rawdescription' =>
                            // TRANS: Plugin description.
                            _m('The LDAP Authorization plugin allows for MicroService to handle authorization through LDAP.'));
        return true;
    }
}
