        ...
        if (!$this->conn) {
            ...
            $config->readArray(
                array(
                    ...
                    'microservice.messagecallback' => array($this, 'handle_irc_message'),
                    'microservice.regcallback' => array($this, 'handle_reg_response'),
                    'microservice.connectedcallback' => array($this, 'handle_connected'),
                    'microservice.unregregexp' => $this->plugin->unregregexp,
                    'microservice.regregexp' => $this->plugin->regregexp
                )
            );
