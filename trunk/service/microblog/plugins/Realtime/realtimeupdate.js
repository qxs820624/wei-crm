 ...
 * Copyright (C) 2009-2011, MicroService, Inc.
 *
 ...
 *       the PHP side of MicroService, which makes it very difficult to maintain
...
RealtimeUpdate = {
      ...
      * needed to build a near-replica of MicroService's NoticeListItem output.
      *
      ...
      *
      * @fixme this replicates core MicroService code, making maintenance harder
