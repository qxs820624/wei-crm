...
class MinifyPlugin extends Plugin
{
    ...
    function minifyUrl($src) {
        return common_local_url('minify',null,array('f' => $src ,v => MICROSERVICE_VERSION));
    }
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'Minify',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:Minify',
                            'rawdescription' =>
                            // TRANS: Plugin description.
                            _m('The Minify plugin minifies MicroService\'s CSS and JavaScript, removing whitespace and comments.'));
        return true;
    }
}
