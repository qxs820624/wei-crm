 ...
 * Replace 'id' with the ID your microservice installation has in your Piwik
...
class PiwikAnalyticsPlugin extends Plugin
{
    ...
    /** the Piwik Id of your microservice installation */
    public $piwikId   = null;
...
ENDOFPIWIK;
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'PiwikAnalytics',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:Piwik',
                            'rawdescription' =>
