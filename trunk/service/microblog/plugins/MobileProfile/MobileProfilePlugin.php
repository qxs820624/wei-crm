...
class MobileProfilePlugin extends WAP20Plugin
{
    ...
    function onStartShowMicroServiceStyles($action)
    {
        if (!$this->serveMobile) {
            return true;
        }
        ...
        Event::handle('EndShowMicroServiceStyles', array($action));
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'MobileProfile',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:MobileProfile',
                            'rawdescription' =>
