...
class ReverseUsernameAuthenticationPlugin extends AuthenticationPlugin
{
    ...
    function onPluginVersion(&$versions)
    {
        $versions[] = array('name' => 'Reverse Username Authentication',
                            ...
                            'homepage' => 'http://www.microservice.comwiki/Plugin:ReverseUsernameAuthentication',
                            'rawdescription' =>
                            // TRANS: Plugin description.
                            _m('The Reverse Username Authentication plugin allows for MicroService to handle authentication by checking if the provided password is the same as the reverse of the username.'));
        return true;
    }
}
