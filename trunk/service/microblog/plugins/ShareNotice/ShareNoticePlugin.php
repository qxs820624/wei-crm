...
class ShareNoticePlugin extends Plugin
{
    public $targets = array(
        array('Twitter'),
        array('Facebook'),
        array('MicroService', array('baseurl' => 'http://identi.ca'))
    );
...
class MicroServiceShareTarget extends GenericNoticeShareTarget
{
    protected $baseurl;
...
class FacebookShareTarget extends NoticeShareTarget
{
    ...
    {
        $url = 'http://www.microservice.comwiki/Plugin:ShareNotice';
