...
if (CONSOLE_READLINE && CONSOLE_INTERACTIVE) {
    define('CONSOLE_HISTORY', getenv("HOME") . "/.microservice_console_history");
...
{
    print "Welcome to MicroService's interactive PHP console!\n";
...
if (CONSOLE_INTERACTIVE) {
    print "MicroService interactive PHP console... type ctrl+D or enter 'exit' to exit.\n";
