 ...
 * Copyright (C) 2008, MicroService, Inc.
 *
...
var SN = { // MicroService
    ...
    U: { // Utils
        ...
        FormXHR: function(form, onSuccess) {
            $.ajax({
                ...
                error: function (xhr, textStatus, errorThrown) {
                    // If the server end reported an error from MicroService,
        ...
        MicroServiceInstance: {
             ...
             */
            Set: function(value) {
                var SNI = SN.U.MicroServiceInstance.Get();
                if (SNI !== null) {
                    value = $.extend(SNI, value);
                }

                $.cookie(
                    SN.C.S.MicroServiceInstance,
             ...
             */
            Get: function() {
                var cookieValue = $.cookie(SN.C.S.MicroServiceInstance);
                if (cookieValue !== null) {
             ...
             */
            Delete: function() {
                $.cookie(SN.C.S.MicroServiceInstance, null);
            }
        },
    ...
    Init: {
         ...
         */
        Login: function() {
            if (SN.U.MicroServiceInstance.Get() !== null) {
                var nickname = SN.U.MicroServiceInstance.Get().Nickname;
                if (nickname !== null) {
            ...
            $('#form_login').bind('submit', function() {
                SN.U.MicroServiceInstance.Set({Nickname: $('#form_login #nickname').val()});
                return true;
            });
        },
