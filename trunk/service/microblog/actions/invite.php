...
class InviteAction extends Action
{
    ...
    function handle($args)
    {
        ...
        if (!common_config('invite', 'enabled')) {
            ...
            // TRANS: %s is the MicroService site name.
    ...
    function showInvitationSuccess()
    {
        if (Event::handle('StartShowInvitationSuccess', array($this))) {
            if ($this->already) {
                // TRANS: Message displayed inviting users to use a MicroService site while the inviting user
            ...
            if ($this->subbed) {
                // TRANS: Message displayed inviting users to use a MicroService site while the invited user
                // TRANS: already uses a this MicroService site. Plural form is based on the number of
            ...
            if ($this->sent) {
                // TRANS: Message displayed inviting users to use a MicroService site. Plural form is
                ...
                // TRANS: people to join a MicroService site.
    ...
    function sendInvitation($email, $user, $personal)
    {
        ...
        // TRANS: the MicroService sitename.
