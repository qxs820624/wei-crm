 ...
 * RSD, while adding information useful to MicroService client developers.
 * In particular:
 *
...
class RsdAction extends Action
{
    ...
    function handle($args)
    {
        ...
        $this->element('engineName', null, _('MicroService'));
        $this->element('engineLink', null, 'http://www.microservice.com');
        ...
        if (Event::handle('StartRsdListApis', array($this, $this->user))) {
            ...
            $this->element('docs', null,
                           'http://www.microservice.comwiki/TwitterCompatibleAPI');
