...
class ApiOauthAuthorizeAction extends Action
{
    ...
    function prepare($args)
    {
        ...
        $this->store           = new ApiMicroServiceOAuthDataStore();
	...
	$this->hidden('mode', $this->mode);
        ...
        if ($this->app->name == 'anonymous') {
            ...
            // TRANS: %3$s is the access type requested (read-write or read-only), %4$s is the MicroService sitename.
            ...
            // TRANS: %3$s is the access type requested, %4$s is the MicroService sitename.
