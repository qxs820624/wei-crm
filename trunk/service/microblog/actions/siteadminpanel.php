...
class SiteadminpanelAction extends AdminPanelAction
{
    ...
    function getInstructions()
    {
        ...
        return _('Basic settings for this MicroService site');
    }
...
class SiteAdminPanelForm extends AdminForm
{
    ...
    function showLogo()
    {
        ...
        $this->li();
        $this->input('logo',
                     // TRANS: Field label for MicroService site logo.
                     _('Site logo'),
                     // TRANS: Title for field label for MicroService site logo.
                     'Logo for the site (full URL).');
        $this->unli();

        $this->li();
        $this->input('ssllogo',
                     // TRANS: Field label for SSL MicroService site logo.
                     _('SSL logo'),
                     // TRANS: Title for field label for SSL MicroService site logo.
