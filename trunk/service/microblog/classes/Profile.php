...
class Profile extends Managed_DataObject
{
    ...
    function asAtomAuthor($cur = null)
    {
        ...
        if ($cur != null) {
            ...
            $xs->element('microservice:profile_info', $attrs, null);
        }
     ...
     *
     * @return array representation of <microservice:profile_info> element or null
     */
    ...
    function profileInfo($cur)
    {
        ...
        return array('microservice:profile_info', $profileInfoAttr, null);
    }
