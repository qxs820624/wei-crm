...
class ShopAction extends CommonAction {
    ...
    private function createCheck() {
        ...
        $data = $this->checkFields($this->_post('data', false), array('cate_id', 'tel', 'qq','logo', 'photo', 'shop_name', 'contact', 'details', 'business_time','city_id', 'area_id','business_id', 'addr', 'lng', 'lat'));
