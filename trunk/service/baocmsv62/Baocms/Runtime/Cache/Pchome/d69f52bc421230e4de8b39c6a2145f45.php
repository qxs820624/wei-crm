...
<div class="content"> 
    ...
    <div class="hdsy_tabList">
        <ul>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li class="hdsy_Li">
                    <div class="left hdsy_Li_l">
                        ...
                        <div class="hdsy_LiTime">
                            有效期：至<?php echo ($item["sign_end"]); ?>
                           
                            <span class="hdsy_LiP"><span class="hdsy_Libms"><?php echo ($item["sign_num"]); ?></span>人已报名</span>
                        </div>
                        <p class="hdsy_LiPJj">地址：<?php echo ($item["addr"]); ?></p>
                        <p class="hdsy_LiPJj">商家：<a target="_blank" href="<?php echo U('shop/detail',array('shop_id'=>$item['shop_id']));?>"><?php echo ($shops[$item['shop_id']]['shop_name']); ?></a></p>
                        <div class="hdsy_Licj">
                            <div class="left hdsy_Licj_l"><em class="radius100"></em><?php echo ($shops[$item['shop_id']]['tel']); if($shops[$item['shop_id']]['extension'] != null): ?>转<?php echo ($shops[$item['shop_id']]['extension']); ?>分机<?php endif; ?></div>
                            
                         
<?php if($item['sign_end'] < $today): ?><div class="right hdsy_Licj_r"><a href="<?php echo U('huodong/detail',array('activity_id'=>$item['activity_id']));?>" class="hdsy_LicjA">历史报名详情</a></div>
<?php else: ?>
<div class="right hdsy_Licj_r"><a href="<?php echo U('huodong/detail',array('activity_id'=>$item['activity_id']));?>" class="hdsy_LicjA">立即参加</a></div><?php endif; ?>                           
                        </div>
                    </div>
                    <div class="right hdsy_Li_r"><a target="_blank" href="<?php echo U('huodong/detail',array('activity_id'=>$item['activity_id']));?>"><img width="579" height="392" src="__ROOT__/attachs/<?php echo ($item["photo"]); ?>"></a></div>
