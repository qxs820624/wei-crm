    ...
    <div class="ncs-goods-summary">
      ...
      <div class="ncs-meta">
        ...
        <div class="ncs-book-down">
          ...
          <div class="rule-info"><a mef="sqde" href="javascript:void(0);">预定规则<i class="icon-question-sign"></i>
            <ul>
...
$shownLevelSkus[$sku] = true; ?>
                        <li title="<?php echo $g['name']; ?>"><a mef="sqde" target="_blank" href="<?php echo urlShop('goods', 'index', array('goods_id' => $sku)); ?>"> <img alt="" src="<?php echo cthumb($g['goods_image'], 60); ?>"/>
