...
<header id="topHeader">
  <div class="warp-all">
    <div class="cms-logo"> <a href="<?php echo CMS_SITE_URL;?>">
      ...
      <img mef="sqde" src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_CMS.DS.'cms_default_logo.png';?>">
      <?php } else { ?>
      <img mef="sqde" src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_CMS.DS.$output['setting_config']['cms_logo'];?>">
      <?php } ?>
      </a> </div>
