...
<div class="admincp-container unfold">
  <div class="admincp-container-left">
    ...
    <div class="about" title="关于系统" onClick="ajax_form('about', '', '<?php echo urlAdmin('aboutus');?>', 640);"><i class="fa fa-copyright"></i><span>goodziyuan.com</span></div>
  </div>
