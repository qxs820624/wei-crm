...
--
-- 表的结构 `ims_abc_replace`
--

CREATE TABLE IF NOT EXISTS `ims_abc_replace` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `replace` varchar(32) default NULL,
  `name` varchar(32) default NULL,
  `uniacid` int(11) unsigned NOT NULL default '0',
  PRIMARY KEY  (`id`),
  KEY `uniacid` USING BTREE (`uniacid`),
  KEY `id` USING BTREE (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=13 ;

--
-- 转存表中的数据 `ims_abc_replace`
--

INSERT INTO `ims_abc_replace` (`id`, `replace`, `name`, `uniacid`) VALUES
(1, '#用户ID#', 'uid', 1),
(2, '#用户名#', 'username', 1),
(3, '#会员组#', 'groupid', 1),
(4, '#积分#', 'credit1', 1),
...
INSERT INTO `ims_account_wechats` (`acid`, `uniacid`, `token`, `encodingaeskey`, `access_token`, `level`, `name`, `account`, `original`, `signature`, `country`, `province`, `city`, `username`, `password`, `lastupdate`, `key`, `secret`, `styleid`, `jsapi_ticket`, `subscribeurl`, `card_ticket`, `auth_refresh_token`) VALUES
...
--
-- 表的结构 `ims_amouse_weicard_companyinfo`
--
...
--
-- 表的结构 `ims_amouse_weicard_industry`
--
...
--
-- 转存表中的数据 `ims_amouse_weicard_industry`
--

INSERT INTO `ims_amouse_weicard_industry` (`id`, `title`, `displayorder`) VALUES
(1, 'IT·互联网·游戏', 1),
(2, '金融业（投资·保险·证券·基金）', 2),
(3, '医疗·保健·美容', 4),
(4, '教育·培训·科研·院校', 5),
...
--
-- 表的结构 `ims_amouse_weicard_member`
--
...
--
-- 表的结构 `ims_amouse_weicard_mycollect`
--
...
--
-- 表的结构 `ims_amouse_weicard_presence`
--
...
--
-- 表的结构 `ims_amouse_weicard_sysset`
--
...
CREATE TABLE IF NOT EXISTS `ims_bbb_reply` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `ims_bbb_user` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `ims_bbb_winner` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `rid` int(10) unsigned NOT NULL COMMENT '规则ID',
...
('setting', 'a:7:{s:8:"authmode";i:1;s:5:"close";a:2:{s:6:"status";s:1:"0";s:6:"reason";s:0:"";}s:9:"copyright";a:20:{s:6:"status";s:1:"0";s:6:"reason";s:9:"备份！";s:8:"sitename";s:30:"好资源微信管理系统";s:3:"url";s:23:"http://www.goodziyuan.com";s:8:"statcode";s:0:"";s:10:"footerleft";s:14:"www.goodziyuan.com";s:11:"footerright";s:37:"好资源源码论坛 微信专题";s:4:"icon";s:0:"";s:5:"flogo";s:24:"images/global/wechat.png";s:5:"blogo";s:24:"images/global/wechat.png";s:8:"baidumap";a:2:{s:3:"lng";s:10:"114.060055";s:3:"lat";s:9:"22.529554";}s:7:"company";s:0:"";s:7:"address";s:30:"好资源微信管理系统";s:6:"person";s:0:"";s:5:"phone";s:11:"15800000000";s:2:"qq";s:9:"278869155";s:5:"email";s:0:"";s:8:"keywords";s:30:"好资源微信管理系统";s:11:"description";s:30:"好资源微信管理系统";s:12:"showhomepage";i:1;}s:8:"platform";a:4:{s:5:"token";s:32:"N8285nNCNns7W7o02387o15n773220lD";s:14:"encodingaeskey";s:43:"NUfqXAg0aOBAPgxCJ2aOy70BaB2Xq0xCtYNYozCt0tJ";s:9:"appsecret";s:0:"";s:5:"appid";s:0:"";}s:8:"register";a:4:{s:4:"open";i:1;s:6:"verify";i:0;s:4:"code";i:1;s:7:"groupid";i:1;}s:4:"site";s:0:"";s:7:"cloudip";s:0:"";}'),
('menus:platform', 'a:0:{}'),
('menus:site', 'a:0:{}');
INSERT INTO `ims_core_cache` (`key`, `value`) VALUES
...
('checkupgrade:system', 'a:1:{s:10:"lastupdate";i:1445871409;}'),
...
('copyright', 'a:20:{s:6:"status";s:1:"0";s:6:"reason";s:9:"备份！";s:8:"sitename";s:30:"好资源微信管理系统";s:3:"url";s:23:"http://www.goodziyuan.com";s:8:"statcode";s:0:"";s:10:"footerleft";s:14:"www.goodziyuan.com";s:11:"footerright";s:37:"好资源源码论坛 微信专题";s:4:"icon";s:0:"";s:5:"flogo";s:24:"images/global/wechat.png";s:5:"blogo";s:24:"images/global/wechat.png";s:8:"baidumap";a:2:{s:3:"lng";s:10:"114.060055";s:3:"lat";s:9:"22.529554";}s:7:"company";s:0:"";s:7:"address";s:30:"好资源微信管理系统";s:6:"person";s:0:"";s:5:"phone";s:11:"15800000000";s:2:"qq";s:9:"278869155";s:5:"email";s:0:"";s:8:"keywords";s:30:"好资源微信管理系统";s:11:"description";s:30:"好资源微信管理系统";s:12:"showhomepage";i:1;}'),
...
--
-- 表的结构 `ims_cut_zongzi_billboard`
--

CREATE TABLE IF NOT EXISTS `ims_cut_zongzi_billboard` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- 表的结构 `ims_cut_zongzi_settings`
--

CREATE TABLE IF NOT EXISTS `ims_cut_zongzi_settings` (
  `id` int(11) NOT NULL auto_increment,
  `uniacid` int(10) NOT NULL,
...
--
-- 表的结构 `ims_dream_reply`
--

CREATE TABLE IF NOT EXISTS `ims_dream_reply` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `rid` int(10) unsigned NOT NULL default '0',
...
CREATE TABLE IF NOT EXISTS `ims_dream_wish` (
  `id` int(11) NOT NULL auto_increment,
  `weid` int(11) default '0',
  `rid` int(11) default '0',
  `fansID` int(11) default '0',
...
CREATE TABLE IF NOT EXISTS `ims_eudy_ads` (
  `id` int(10) NOT NULL auto_increment,
  `weid` int(10) NOT NULL,
...
--
-- 表的结构 `ims_eudy_ads_user`
--

CREATE TABLE IF NOT EXISTS `ims_eudy_ads_user` (
...
--
-- 表的结构 `ims_ewei_bonus_fans_record`
--
...
--
-- 表的结构 `ims_ewei_comeon_award`
--

CREATE TABLE IF NOT EXISTS `ims_ewei_comeon_award` (
  `id` int(11) NOT NULL auto_increment,
  `rid` int(11) default '0',
...
--
-- 表的结构 `ims_ewei_comeon_fans`
--

CREATE TABLE IF NOT EXISTS `ims_ewei_comeon_fans` (
  `id` int(11) NOT NULL auto_increment,
  `rid` int(11) default '0',
...
--
-- 表的结构 `ims_ewei_comeon_fans_help`
--

CREATE TABLE IF NOT EXISTS `ims_ewei_comeon_fans_help` (
  `id` int(11) NOT NULL auto_increment,
  `rid` int(11) default '0',
...
--
-- 表的结构 `ims_ewei_comeon_reply`
--

CREATE TABLE IF NOT EXISTS `ims_ewei_comeon_reply` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `rid` int(10) unsigned default '0',
  `weid` int(11) default '0',
  `title` varchar(50) default '',
...
--
-- 表的结构 `ims_ewei_comeon_rule`
--

CREATE TABLE IF NOT EXISTS `ims_ewei_comeon_rule` (
  `id` int(11) NOT NULL auto_increment,
  `rid` int(11) default '0',
  `point` decimal(10,2) default '0.00',
  `start` decimal(10,2) default '0.00',
...
--
-- 表的结构 `ims_ewei_comeon_sysset`
--

CREATE TABLE IF NOT EXISTS `ims_ewei_comeon_sysset` (
  `id` int(11) NOT NULL auto_increment,
  `weid` int(11) default '0',
  `appid` varchar(255) default '',
  `appsecret` varchar(255) default '',
...
--
-- 表的结构 `ims_ewei_exam_course_category`
--
...
--
-- 表的结构 `ims_ewei_exam_course_reserve`
--
...
--
-- 表的结构 `ims_ewei_exam_paper_category`
--
...
--
-- 表的结构 `ims_ewei_exam_paper_member_data`
--
...
--
-- 表的结构 `ims_ewei_exam_paper_member_record`
--
...
--
-- 表的结构 `ims_ewei_exam_paper_question`
--
...
--
-- 表的结构 `ims_ewei_takephotoa_fans_score`
--
...
--
-- 表的结构 `ims_ewei_takephotoa_reply`
--
...
--
-- 表的结构 `ims_ewei_takephotoa_sysset`
--
...
--
-- 表的结构 `ims_fighting_question_worng`
--
...
CREATE TABLE IF NOT EXISTS `ims_fl_wsq_area` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='微社区地区表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_fl_wsq_config`
--
...
CREATE TABLE IF NOT EXISTS `ims_fl_wsq_config` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='微社区配置文件' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_fl_wsq_search_log`
--
...
CREATE TABLE IF NOT EXISTS `ims_fl_wsq_search_log` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='微社区搜索记录' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_fl_wsq_shoping`
--
...
CREATE TABLE IF NOT EXISTS `ims_fl_wsq_shoping` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='社区商户列表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_fl_wsq_shoping_reg`
--
...
CREATE TABLE IF NOT EXISTS `ims_fl_wsq_shoping_reg` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商户申请表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_fl_wsq_shoping_type`
--
...
CREATE TABLE IF NOT EXISTS `ims_fl_wsq_shoping_type` (
  ...
  `weid` int(11) NOT NULL COMMENT '公众号id',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商户分类表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_fl_wsq_shoping_type_bind`
--
...
CREATE TABLE IF NOT EXISTS `ims_fl_wsq_shoping_type_bind` (
  ...
  `create_time` int(11) NOT NULL COMMENT '创建时间',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='商铺分类绑定表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_fl_wsq_slide`
--
...
CREATE TABLE IF NOT EXISTS `ims_fl_wsq_slide` (
  ...
  `weid` int(11) NOT NULL COMMENT '公众号id',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='幻灯片管理' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_fm_photosvote_advs`
--
...
--
-- 表的结构 `ims_fm_photosvote_announce`
--
...
--
-- 表的结构 `ims_fm_photosvote_awarding`
--
...
--
-- 表的结构 `ims_fm_photosvote_awardingtype`
--
...
--
-- 表的结构 `ims_fm_photosvote_banners`
--
...
--
-- 表的结构 `ims_fm_photosvote_bbsreply`
--
...
--
-- 表的结构 `ims_fm_photosvote_giftmika`
--
...
--
-- 表的结构 `ims_fm_photosvote_iplistlog`
--
...
--
-- 表的结构 `ims_fm_photosvote_provevote`
--
...
--
-- 表的结构 `ims_fm_photosvote_provevote_name`
--
...
--
-- 表的结构 `ims_fm_photosvote_provevote_voice`
--
...
--
-- 表的结构 `ims_fm_photosvote_votelog`
--
...
--
-- 表的结构 `ims_hc_ybdzs_setting`
--

CREATE TABLE IF NOT EXISTS `ims_hc_ybdzs_setting` (
  `id` int(10) NOT NULL auto_increment,
  `weid` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_hongapis` (
  `id` int(11) NOT NULL auto_increment,
  `weid` int(11) NOT NULL,
  `type` varchar(255) NOT NULL,
...
--
-- 表的结构 `ims_hongapitype`
--

CREATE TABLE IF NOT EXISTS `ims_hongapitype` (
  `id` int(11) NOT NULL auto_increment,
  `weid` int(11) NOT NULL,
  `type` varchar(255) default NULL,
  `express_id` varchar(20) NOT NULL,
...
--
-- 表的结构 `ims_hx_cards_award`
--

CREATE TABLE IF NOT EXISTS `ims_hx_cards_award` (
  `id` int(10) NOT NULL auto_increment,
...
--
-- 表的结构 `ims_hx_cards_fans`
--

CREATE TABLE IF NOT EXISTS `ims_hx_cards_fans` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
--
-- 表的结构 `ims_hx_cards_reply`
--

CREATE TABLE IF NOT EXISTS `ims_hx_cards_reply` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `rid` int(10) unsigned NOT NULL,
  `uniacid` int(10) unsigned NOT NULL,
...
--
-- 表的结构 `ims_hx_cards_share`
--

CREATE TABLE IF NOT EXISTS `ims_hx_cards_share` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
--
-- 表的结构 `ims_jufeng_wcy_order_foods`
--
...
--
-- 表的结构 `ims_junsion_qixiqueqiao_player`
--
...
--
-- 表的结构 `ims_junsion_qixiqueqiao_prize`
--
...
--
-- 表的结构 `ims_junsion_qixiqueqiao_record`
--
...
--
-- 表的结构 `ims_junsion_qixiqueqiao_rule`
--
...
--
-- 表的结构 `ims_junsion_qixiqueqiao_share`
--
...
--
-- 表的结构 `ims_jy_wei_company`
--

CREATE TABLE IF NOT EXISTS `ims_jy_wei_company` (
  `id` int(11) NOT NULL auto_increment,
  `uniacid` int(11) unsigned NOT NULL,
...
--
-- 表的结构 `ims_jy_wei_invitation`
--

CREATE TABLE IF NOT EXISTS `ims_jy_wei_invitation` (
  `id` int(11) NOT NULL auto_increment,
  `uniacid` int(11) unsigned NOT NULL,
...
--
-- 表的结构 `ims_jy_wei_keyword`
--

CREATE TABLE IF NOT EXISTS `ims_jy_wei_keyword` (
  `id` int(11) NOT NULL auto_increment,
  `uniacid` int(11) unsigned NOT NULL,
...
--
-- 表的结构 `ims_jy_wei_label`
--

CREATE TABLE IF NOT EXISTS `ims_jy_wei_label` (
  `id` int(11) NOT NULL auto_increment,
  `uniacid` int(11) unsigned NOT NULL,
  `companyid` int(11) NOT NULL default '0',
...
CREATE TABLE IF NOT EXISTS `ims_jy_wei_log` (
  `id` int(11) NOT NULL auto_increment,
  `uniacid` int(11) unsigned NOT NULL,
  `uid` int(11) unsigned NOT NULL,
  `companyid` int(11) unsigned NOT NULL,
...
--
-- 表的结构 `ims_jy_wei_position`
--

CREATE TABLE IF NOT EXISTS `ims_jy_wei_position` (
  `id` int(11) NOT NULL auto_increment,
  `uniacid` int(11) unsigned NOT NULL,
  `companyid` int(11) NOT NULL default '0',
...
--
-- 表的结构 `ims_jy_wei_rule`
--

CREATE TABLE IF NOT EXISTS `ims_jy_wei_rule` (
  `id` int(11) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `ims_kim_sign_prizes` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='签到奖品' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_kim_sign_prizes_group`
--
...
CREATE TABLE IF NOT EXISTS `ims_kim_sign_prizes_group` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='奖品分组' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_kim_sign_prizes_record`
--
...
CREATE TABLE IF NOT EXISTS `ims_kim_sign_prizes_record` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='奖品发放记录' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_kim_sign_record`
--
...
CREATE TABLE IF NOT EXISTS `ims_kim_sign_record` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='签到记录' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_kim_sign_reply`
--
...
CREATE TABLE IF NOT EXISTS `ims_kim_sign_reply` (
  ...
  `description` text COMMENT '描述',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='回复规则' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_lee_tlvoice_record`
--
...
--
-- 表的结构 `ims_lions_zq_billboard`
--

CREATE TABLE IF NOT EXISTS `ims_lions_zq_billboard` (
  `id` int(11) NOT NULL auto_increment,
  `uniacid` int(10) NOT NULL,
  `openid` varchar(255) default NULL,
  `score` varchar(10) NOT NULL default '0',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='月球来的月饼' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_lions_zq_settings`
--

CREATE TABLE IF NOT EXISTS `ims_lions_zq_settings` (
  `id` int(11) NOT NULL auto_increment,
  `uniacid` int(10) NOT NULL,
  `setting_key` varchar(255) NOT NULL,
  `setting_value` varchar(255) NOT NULL,
...
--
-- 表的结构 `ims_lovehelper_ip`
--

CREATE TABLE IF NOT EXISTS `ims_lovehelper_ip` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- 表的结构 `ims_lovehelper_msg`
--

CREATE TABLE IF NOT EXISTS `ims_lovehelper_msg` (
  `id` int(11) NOT NULL auto_increment,
  `content` text NOT NULL,
...
--
-- 表的结构 `ims_lovehelper_res`
--

CREATE TABLE IF NOT EXISTS `ims_lovehelper_res` (
  `id` int(11) NOT NULL auto_increment,
  `name` varchar(50) NOT NULL,
...
--
-- 表的结构 `ims_lxy_buildpro_album`
--

CREATE TABLE IF NOT EXISTS `ims_lxy_buildpro_album` (
  `id` int(11) NOT NULL auto_increment,
  `weid` int(11) default NULL,
  ...
  `pic` text,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='楼盘相册' AUTO_INCREMENT=82 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_lxy_buildpro_bill`
--
...
CREATE TABLE IF NOT EXISTS `ims_lxy_buildpro_bill` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='楼盘海报' AUTO_INCREMENT=31 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_lxy_buildpro_expert_comment`
--
...
CREATE TABLE IF NOT EXISTS `ims_lxy_buildpro_expert_comment` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='楼盘-专家点评' AUTO_INCREMENT=29 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_lxy_buildpro_fell`
--
...
CREATE TABLE IF NOT EXISTS `ims_lxy_buildpro_fell` (
  ...
  `createtime` int(11) default NULL,
  PRIMARY KEY  (`yid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='房友印象' AUTO_INCREMENT=106 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_lxy_buildpro_fell_record`
--
...
CREATE TABLE IF NOT EXISTS `ims_lxy_buildpro_fell_record` (
  ...
  `title` varchar(255) default NULL COMMENT '标题',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='房友印象' AUTO_INCREMENT=146 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_lxy_buildpro_full_view`
--
...
CREATE TABLE IF NOT EXISTS `ims_lxy_buildpro_full_view` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='楼盘户型全景' AUTO_INCREMENT=84 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_lxy_buildpro_head`
--
...
CREATE TABLE IF NOT EXISTS `ims_lxy_buildpro_head` (
  ...
  `createtime` int(11) default NULL,
  PRIMARY KEY  (`hid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='楼盘简介' AUTO_INCREMENT=53 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_lxy_buildpro_house`
--
...
CREATE TABLE IF NOT EXISTS `ims_lxy_buildpro_house` (
  ...
  `createtime` int(11) default NULL,
  PRIMARY KEY  (`hsid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='楼盘户型' AUTO_INCREMENT=90 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_lxy_buildpro_reply`
--
...
CREATE TABLE IF NOT EXISTS `ims_lxy_buildpro_sub` (
  ...
  `jianjie` text,
  PRIMARY KEY  (`sid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='子楼盘' AUTO_INCREMENT=65 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_lxy_marry_info`
--
...
CREATE TABLE IF NOT EXISTS `ims_lxy_marry_info` (
  ...
  KEY `idx_sid` (`sid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='微喜帖信息列表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_lxy_marry_list`
--
...
INSERT INTO `ims_mc_groups` (`groupid`, `uniacid`, `title`, `orderlist`, `isdefault`) VALUES
(1, 1, '默认会员组', 0, 1);
...
--
-- 表的结构 `ims_meepoweixiangqin_slide`
--
...
CREATE TABLE IF NOT EXISTS `ims_meepo_bbs_home_message` (
  ...
  PRIMARY KEY  (`id`),
  KEY `fromopenid` USING BTREE (`fromopenid`),
  KEY `toopenid` USING BTREE (`toopenid`),
  KEY `tid` USING BTREE (`tid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=14111 ;
...
CREATE TABLE IF NOT EXISTS `ims_meepo_bbs_topic_like` (
  ...
  KEY `fid` USING BTREE (`fid`),
  KEY `openid` USING BTREE (`openid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=496 ;
...
CREATE TABLE IF NOT EXISTS `ims_meepo_bbs_topic_read` (
  ...
  KEY `openid` USING BTREE (`openid`),
  KEY `tid` USING BTREE (`tid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=17240 ;
...
--
-- 表的结构 `ims_meepo_module`
--

CREATE TABLE IF NOT EXISTS `ims_meepo_module` (
  `id` int(11) unsigned NOT NULL auto_increment,
...
--
-- 表的结构 `ims_meepo_sexy_set`
--

CREATE TABLE IF NOT EXISTS `ims_meepo_sexy_set` (
  `id` int(11) NOT NULL auto_increment,
  `weid` int(11) default NULL,
  `name` varchar(50) default NULL,
...
CREATE TABLE IF NOT EXISTS `ims_meepo_sub` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `uniacid` int(11) unsigned NOT NULL default '0',
  `uid` int(11) unsigned NOT NULL default '0',
  `num` int(11) unsigned NOT NULL default '0',
  ...
  KEY `num` USING BTREE (`num`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=73117 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_meepo_sub_log`
--

CREATE TABLE IF NOT EXISTS `ims_meepo_sub_log` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `uniacid` int(11) unsigned NOT NULL default '0',
  `acid` int(11) unsigned NOT NULL default '0',
  `uid` int(11) unsigned NOT NULL default '0',
...
CREATE TABLE IF NOT EXISTS `ims_mon_house` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `weid` int(11) default '0',
  `rid` int(11) default '0',
...
--
-- 表的结构 `ims_mon_orderform`
--

CREATE TABLE IF NOT EXISTS `ims_mon_orderform` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `rid` int(10) NOT NULL,
  `weid` int(11) NOT NULL,
...
--
-- 表的结构 `ims_mon_orderform_item`
--

CREATE TABLE IF NOT EXISTS `ims_mon_orderform_item` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
--
-- 表的结构 `ims_mon_orderform_order`
--

CREATE TABLE IF NOT EXISTS `ims_mon_orderform_order` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
--
-- 表的结构 `ims_mon_orderform_setting`
--

CREATE TABLE IF NOT EXISTS `ims_mon_orderform_setting` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `weid` int(10) NOT NULL,
...
--
-- 表的结构 `ims_mon_orderform_template`
--

CREATE TABLE IF NOT EXISTS `ims_mon_orderform_template` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `weid` int(10) NOT NULL,
...
--
-- 表的结构 `ims_scene_cube_app`
--

CREATE TABLE IF NOT EXISTS `ims_scene_cube_app` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
--
-- 转存表中的数据 `ims_scene_cube_app`
--

INSERT INTO `ims_scene_cube_app` (`id`, `listorder`, `iden`, `price`, `title`, `thumb`, `qrcode`, `author`, `series`, `isshow`, `create_time`) VALUES
...
--
-- 表的结构 `ims_sinrch_dataosha_setting`
--
...
--
-- 表的结构 `ims_stonefish_bigwheel_exchange`
--
...
--
-- 表的结构 `ims_stonefish_bigwheel_fansaward`
--
...
--
-- 表的结构 `ims_stonefish_bigwheel_fanstmplmsg`
--
...
--
-- 表的结构 `ims_stonefish_bigwheel_prizemika`
--
...
--
-- 表的结构 `ims_stonefish_bigwheel_sharedata`
--
...
--
-- 表的结构 `ims_stonefish_bigwheel_template`
--
...
--
-- 表的结构 `ims_stonefish_bigwheel_tmplmsg`
--
...
--
-- 表的结构 `ims_stonefish_chailihe_banner`
--
...
--
-- 表的结构 `ims_stonefish_chailihe_exchange`
--
...
--
-- 表的结构 `ims_stonefish_chailihe_fans`
--
...
--
-- 表的结构 `ims_stonefish_chailihe_fansaward`
--
...
--
-- 表的结构 `ims_stonefish_chailihe_fanstmplmsg`
--
...
--
-- 表的结构 `ims_stonefish_chailihe_lihestyle`
--
...
--
-- 表的结构 `ims_stonefish_chailihe_prize`
--
...
--
-- 表的结构 `ims_stonefish_chailihe_prizemika`
--
...
--
-- 表的结构 `ims_stonefish_chailihe_reply`
--
...
--
-- 表的结构 `ims_stonefish_chailihe_share`
--
...
--
-- 表的结构 `ims_stonefish_chailihe_sharedata`
--
...
--
-- 表的结构 `ims_stonefish_chailihe_template`
--
...
--
-- 表的结构 `ims_stonefish_chailihe_tmplmsg`
--
...
--
-- 表的结构 `ims_stonefish_luckynum_award`
--
...
--
-- 表的结构 `ims_stonefish_luckynum_fans`
--
...
--
-- 表的结构 `ims_stonefish_planting_award`
--
...
--
-- 表的结构 `ims_stonefish_planting_data`
--
...
--
-- 表的结构 `ims_stonefish_planting_fans`
--
...
--
-- 表的结构 `ims_stonefish_planting_prize`
--
...
--
-- 表的结构 `ims_stonefish_planting_reply`
--
...
--
-- 表的结构 `ims_stonefish_planting_seed`
--
...
--
-- 转存表中的数据 `ims_stonefish_planting_seed`
--
...
--
-- 表的结构 `ims_stonefish_planting_share`
--
...
--
-- 表的结构 `ims_stonefish_planting_token`
--
...
--
-- 表的结构 `ims_stonefish_redenvelope_award`
--
...
--
-- 表的结构 `ims_stonefish_redenvelope_data`
--
...
--
-- 表的结构 `ims_stonefish_redenvelope_fans`
--
...
--
-- 表的结构 `ims_stonefish_redenvelope_prize`
--
...
--
-- 表的结构 `ims_stonefish_redenvelope_reply`
--
...
--
-- 表的结构 `ims_stonefish_redenvelope_share`
--
...
--
-- 表的结构 `ims_stonefish_redenvelope_token`
--
...
--
-- 表的结构 `ims_stonefish_scratch_award`
--

CREATE TABLE IF NOT EXISTS `ims_stonefish_scratch_award` (
  `id` int(11) NOT NULL auto_increment,
  `uniacid` int(11) default '0',
  `rid` int(11) default '0',
  `fansID` int(11) default '0',
...
--
-- 表的结构 `ims_stonefish_scratch_data`
--

CREATE TABLE IF NOT EXISTS `ims_stonefish_scratch_data` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `rid` int(10) unsigned NOT NULL default '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL COMMENT '公众号ID',
  `from_user` varchar(50) NOT NULL default '' COMMENT '用户openid',
...
--
-- 表的结构 `ims_stonefish_scratch_fans`
--
...
--
-- 表的结构 `ims_stonefish_scratch_prize`
--
...
--
-- 表的结构 `ims_stonefish_scratch_reply`
--
...
--
-- 表的结构 `ims_stonefish_scratch_share`
--
...
--
-- 表的结构 `ims_sunshine_gaokaotoutiao_member`
--

CREATE TABLE IF NOT EXISTS `ims_sunshine_gaokaotoutiao_member` (
  `id` int(10) NOT NULL auto_increment,
...
--
-- 表的结构 `ims_sunshine_gaokaotoutiao_sucai`
--

CREATE TABLE IF NOT EXISTS `ims_sunshine_gaokaotoutiao_sucai` (
  `id` int(10) NOT NULL auto_increment,
...
--
-- 表的结构 `ims_superman_floor_winner`
--
...
--
-- 表的结构 `ims_super_securitycode_data_moban`
--
...
--
-- 表的结构 `ims_super_securitycode_logs`
--
...
--
-- 表的结构 `ims_super_securitycode_reply`
--
...
--
-- 表的结构 `ims_thinkidea_phonebook_category`
--

CREATE TABLE IF NOT EXISTS `ims_thinkidea_phonebook_category` (
  `id` int(11) NOT NULL auto_increment,
  `weid` int(11) NOT NULL,
...
--
-- 表的结构 `ims_thinkidea_phonebook_info`
--
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='电话本内容' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_thinkidea_phonebook_reply`
--
...
--
-- 表的结构 `ims_thinkidea_phonebook_zone`
--
...
--
-- 表的结构 `ims_thinkidea_secondmarket_category`
--

CREATE TABLE IF NOT EXISTS `ims_thinkidea_secondmarket_category` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- 表的结构 `ims_thinkidea_secondmarket_goods`
--

CREATE TABLE IF NOT EXISTS `ims_thinkidea_secondmarket_goods` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `weid` int(10) unsigned NOT NULL,
  `openid` varchar(50) NOT NULL,
  `title` varchar(20) NOT NULL,
...
--
-- 表的结构 `ims_thinkidea_secondmarket_reply`
--

CREATE TABLE IF NOT EXISTS `ims_thinkidea_secondmarket_reply` (
  `id` int(11) NOT NULL auto_increment,
  `rid` int(11) NOT NULL,
...
INSERT INTO `ims_uni_group` (`id`, `name`, `modules`, `templates`) VALUES
...
INSERT INTO `ims_uni_settings` (`uniacid`, `passport`, `oauth`, `uc`, `notify`, `creditnames`, `creditbehaviors`, `welcome`, `default`, `default_message`, `shortcuts`, `payment`, `groupdata`, `stat`, `menuset`, `default_site`, `sync`, `jsauth_acid`) VALUES
...
INSERT INTO `ims_users` (`uid`, `groupid`, `username`, `password`, `salt`, `status`, `joindate`, `joinip`, `lastvisit`, `lastip`, `remark`) VALUES
(1, 0, 'admin', '16d09a29539c36086361129802b62cdf6ea39471', '2cdc83fc', 0, 1441588853, '', 1446035166, '127.0.0.1', ''),
...
INSERT INTO `ims_users_group` (`id`, `name`, `package`, `maxaccount`, `maxsubaccount`) VALUES
...
--
-- 表的结构 `ims_wdl_hchighguess_images`
--
...
--
-- 表的结构 `ims_wdl_hchighguess_member`
--
...
--
-- 表的结构 `ims_wdl_hchighguess_reply`
--
...
--
-- 表的结构 `ims_wdl_hchighguess_selectlog`
--
...
--
-- 表的结构 `ims_wdl_hchighguess_words`
--
...
CREATE TABLE IF NOT EXISTS `ims_weishare` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `weid` int(11) unsigned default NULL,
...
--
-- 表的结构 `ims_weisrc_audio_music_user`
--
...
--
-- 表的结构 `ims_weisrc_businesscenter_category`
--
...
--
-- 表的结构 `ims_weisrc_businesscenter_city`
--
...
--
-- 表的结构 `ims_weisrc_businesscenter_feedback`
--
...
--
-- 表的结构 `ims_weisrc_businesscenter_news`
--
...
--
-- 表的结构 `ims_weisrc_businesscenter_setting`
--
...
--
-- 表的结构 `ims_weisrc_businesscenter_slide`
--
...
--
-- 表的结构 `ims_weisrc_businesscenter_stores`
--
...
--
-- 表的结构 `ims_weisrc_dragonboat_fans`
--

CREATE TABLE IF NOT EXISTS `ims_weisrc_dragonboat_fans` (
  `id` int(11) NOT NULL auto_increment,
  `weid` int(11) default '0',
  `rid` int(11) default '0',
  `from_user` varchar(50) default '' COMMENT '用户ID',
...
--
-- 表的结构 `ims_weisrc_dragonboat_record`
--

CREATE TABLE IF NOT EXISTS `ims_weisrc_dragonboat_record` (
  `id` int(11) NOT NULL auto_increment,
  `weid` int(11) default '0',
  `rid` int(11) default '0',
  `from_user` varchar(50) default '0' COMMENT '用户ID',
  ...
  KEY `indx_rid` (`rid`),
  KEY `indx_weid` (`weid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=14291 ;

-- --------------------------------------------------------

--
-- 表的结构 `ims_weisrc_dragonboat_reply`
--

CREATE TABLE IF NOT EXISTS `ims_weisrc_dragonboat_reply` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `rid` int(10) unsigned default '0',
  `weid` int(11) default '0',
  `title` varchar(50) default '',
...
--
-- 表的结构 `ims_weisrc_invitative_activity`
--

CREATE TABLE IF NOT EXISTS `ims_weisrc_invitative_activity` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `rid` int(10) unsigned default '0',
...
--
-- 表的结构 `ims_weisrc_invitative_reply`
--
...
--
-- 表的结构 `ims_weisrc_invitative_user`
--
...
--
-- 表的结构 `ims_weisrc_truth_question`
--
...
--
-- 表的结构 `ims_wmb_goshare_giftgroup`
--
...
--
-- 表的结构 `ims_xc_article_article_category`
--
...
--
-- 表的结构 `ims_xc_article_article_reply`
--
...
--
-- 表的结构 `ims_xc_article_share_track`
--
...
--
-- 表的结构 `ims_zerobuy_code`
--

CREATE TABLE IF NOT EXISTS `ims_zerobuy_code` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `weid` int(10) unsigned NOT NULL,
