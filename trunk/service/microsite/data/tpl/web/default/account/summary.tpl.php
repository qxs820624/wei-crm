...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="account-stat-num row">
			<div>新关注人数<span><?php  echo $yesterday_stat['new'];?></span></div>
			<div>取消关注人数<span><?php  echo $yesterday_stat['cancel'];?></span></div>
			<div>净增关注人数<span><?php  echo intval($yesterday_stat['new']) - intval($yesterday_stat['cancel'])?></span></div>
			<div>累积关注人数<span><?php  echo $yesterday_stat['cumulate'];?></span></div>
		</div>
	</div>
</div>
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="account-stat-num row">
			<div>新关注人数<span><?php  echo intval($today_stat['new'])?></span></div>
			<div>取消关注人数<span><?php  echo intval($today_stat['cancel'])?></span></div>
			<div>净增关注人数<span><?php  echo intval($today_stat['new']) - intval($today_stat['cancel'])?></span></div>
			<div>累积关注人数<span><?php  echo $today_stat['cumulate'];?></span></div>
		</div>
	</div>
</div>
